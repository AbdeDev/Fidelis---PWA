 ...
 {  
   // var_dump($_POST);
    ...
    elseif (iconv_strlen($_POST['mdp']) < 6) {
        ...
        $query = $db->prepare('INSERT INTO users (nom_dutilisateur, email, mdp) VALUES (:nom_dutilisateur, :email, :mdp)');
        $query->bindValue(':nom_dutilisateur', $_POST['nom_dutilisateur'], PDO::PARAM_STR);
